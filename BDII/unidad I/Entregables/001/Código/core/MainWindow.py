...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.areaLineEdit = QtWidgets.QLineEdit(self.formLayoutWidget_2)
        font = QtGui.QFont()
        font.setPointSize(12)
        self.areaLineEdit.setFont(font)
        self.areaLineEdit.setObjectName("areaLineEdit")
        self.gridLayout.addWidget(self.areaLineEdit, 0, 1, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.areaLineEdit.setToolTip(_translate("MainWindow", "Seleccione el código de área"))
